...
export type LeadStatus = 'new' | 'contacted' | 'qualified' | 'converted' | 'lost' | 'dead';
...
const LeadSchema = new Schema<ILeadDoc>({
  ...
  message: { type: String },
  status: { type: String, enum: ['new', 'contacted', 'qualified', 'converted', 'lost', 'dead'], default: 'new', index: true },
